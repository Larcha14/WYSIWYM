...
class AircraftModel:
    ...
    def predict(self, df, aircraft):
        ...
        results = {}
        prediction_dfs = []  # Список для хранения DataFrame с предсказаниями
    ...
    def emission_processing(self, df):
        limits = pd.read_excel('./app/DATA/PW1100 Parameters.xlsx', sheet_name='Cruise Report<01>', engine='openpyxl')
        limit_dict = {}
